          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="text-center space-y-4">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed max-w-2xl">
               <p>
               אני דיאטנית קלינית מאז 2019. את דרכי התחלתי בלימודים באוניברסיטה העברית, ולאחר הסטאז' בחרתי להתמחות בתחום שמרגש אותי במיוחד – סוכרת. למה דווקא סוכרת? כי זה המקום שבו תזונה נכונה משנה חיים.
               </p>

               <p>
               עשיתי קורס מקצועי לסוכרת באוניברסיטת תל אביב, ומשם המשכתי לעבוד במכוני סוכרת של מכבי ו-כללית. שם זכיתי ללוות מאות מטופלים – עם סוכרת מסוג 1, סוג 2, LADA, MODY וגם סוכרת הריון – ולעזור להם למצוא את הדרך שלהם לאיזון.
               </p>
